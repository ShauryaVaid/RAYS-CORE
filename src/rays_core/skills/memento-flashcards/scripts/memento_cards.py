...
Data file: $RAYS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RAYS_HOME = Path(os.environ.get("RAYS_HOME", Path.home() / ".rays"))
DATA_DIR = _RAYS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
