...
Usage in execute_code:
    exec(open(os.path.join(os.environ.get("RAYS_HOME", os.path.expanduser("~/.rays")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
...
ULTRAPLINIAN_MODELS = [
    ...
    'nousresearch/rays-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'nousresearch/rays-4-405b',
    # POWER TIER (39-49)
    'nousresearch/rays-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'rays-fast',
            'model': 'nousresearch/rays-4-405b',
