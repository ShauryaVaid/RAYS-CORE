...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("RAYS_HOME", os.path.expanduser("~/.rays")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("RAYS_HOME", Path.home() / ".rays")) / "skills" / "red-teaming" / "godmode" / "scripts"
